...
class ThemeCubit extends Cubit<ThemeMode> {
  ...
  updateStatusBarTheme() {
    SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
      statusBarColor: state == ThemeMode.dark ? MyColor.mainColor : MyColor.bgr1,
      statusBarIconBrightness: state == ThemeMode.dark ? Brightness.light : Brightness.dark,
      systemNavigationBarColor: state == ThemeMode.dark ? MyColor.mainColor : MyColor.bgr1,
...
class MyThemes {
  static final darkTheme = ThemeData.dark().copyWith(
    ...
    appBarTheme: AppBarTheme(
      systemOverlayStyle:
          SystemUiOverlayStyle(statusBarColor: MyColor.mainColorList[0], statusBarIconBrightness: Brightness.light),
    ),
  ...
  static final lightTheme = ThemeData.light().copyWith(
    ...
    appBarTheme: AppBarTheme(
      systemOverlayStyle: SystemUiOverlayStyle(statusBarColor: MyColor.bgr1, statusBarIconBrightness: Brightness.dark),
    ),
    textTheme: TextTheme(
      bodySmall: TextStyle(
        fontSize: 12,
